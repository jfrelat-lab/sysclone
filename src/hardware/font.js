...
/**
 * Authentic VGA 8x16 font ROM (Code Page 437) extracted from DOSBox.
 * 256 characters * 16 scanlines = 4096 bytes.
 * This ensures pixel-perfect rendering for legacy text graphics.
 */
export const fontVGA = new Uint8Array([
