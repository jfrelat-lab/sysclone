// src/hardware/font.js

/**
 * Authentic VGA 8x8 font ROM (Code Page 437) extracted from DOSBox (int10_font_08).
 * Used primarily for low-resolution Graphics Modes (like SCREEN 13).
 * 256 characters * 8 scanlines = 2048 bytes.
 * Ensures pixel-perfect 40x25 character grids on a 320x200 canvas.
 */
export const fontVGA8x8 = new Uint8Array([
...
/**
 * Authentic VGA 8x14 font ROM (Code Page 437) extracted from DOSBox (int10_font_14).
 * Used primarily for EGA Graphics Modes (like SCREEN 9 - 640x350).
 * 256 characters * 14 scanlines = 3584 bytes.
 * Ensures a perfect pixel-exact 80x25 character grid on a 350-line display.
 */
export const fontVGA8x14 = new Uint8Array([
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
/**
 * Authentic VGA 8x16 font ROM (Code Page 437) extracted from DOSBox (int10_font_16).
 * Used primarily for high-resolution Text Modes (like SCREEN 0).
 * 256 characters * 16 scanlines = 4096 bytes.
 * Ensures pixel-perfect rendering for legacy DOS text graphics.
 */
export const fontVGA8x16 = new Uint8Array([
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
